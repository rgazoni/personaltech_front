...
export const LandingPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="flex justify-between gap-16 relative z-50">
        <div className="w-1/3 flex flex-col gap-6">
          <h2
            className="font-bold text-6xl text-secondary w-full"
          >
            Conectamos quem quer treinar com os melhores treinadores
          </h2>
          <CurvedLine />
          <h3 className="text-sm w-64 text-muted leading-relaxed">
        ...
        <div className="container rounded-md mx-auto relative w-3/6 overflow-hidden">
          <img
      ...
      <div className="my-40 bg-[#F9F8FE] -mx-16 relative z-50">
        <div className="mx-16">
          <div className="flex py-14 justify-between gap-10">
            <div className="w-1/2 flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                <p className="font-semibold text-5xl">Como funciona</p>
                <p className="text-muted w-96 leading-relaxed">
      ...
      <div className="flex flex-col items-center relative z-50">
        <p className="text-4xl text-center leading-relaxed w-4/6">
      ...
      <div className="my-44 flex gap-20 relative z-50">
        <div className="w-1/2 flex flex-col gap-10">
          <h2 className="font-semibold text-5xl text-primary"> Se você é um treinador, aqui é sua vitrine!</h2>
      ...
      <div className="bg-footer-background -mx-16 flex flex-col justify-center items-center pb-20 gap-10 relative z-50">
